 ...
 */
class ReceiverRDMAWriteNomultipReadFilter : 
                       public Network::ReadFilter,
                       public Network::WriteFilter,
                       public Network::ConnectionCallbacks,
                       public std::enable_shared_from_this<ReceiverRDMAWriteNomultipReadFilter>,
...
public:
    ...
    // Destructor
    ~ReceiverRDMAWriteNomultipReadFilter() {
    ...
    // Constructor
    ReceiverRDMAWriteNomultipReadFilter(const uint32_t payloadBound, const uint32_t circleSize, const uint32_t timeToWrite, const uint32_t sharedBufferSize)
