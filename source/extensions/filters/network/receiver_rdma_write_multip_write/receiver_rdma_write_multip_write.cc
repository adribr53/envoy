...
Network::FilterStatus ReceiverRDMAWriteMultipWriteFilter::onNewConnection() {
...
Network::FilterStatus ReceiverRDMAWriteMultipWriteFilter::onData(Buffer::Instance& data, bool end_stream) {
...
Network::FilterStatus ReceiverRDMAWriteMultipWriteFilter::onWrite(Buffer::Instance& data, bool end_stream) {
