...
Network::FilterStatus ReceiverRDMAWriteMultipReadFilter::onNewConnection() {
...
Network::FilterStatus ReceiverRDMAWriteMultipReadFilter::onData(Buffer::Instance& data, bool end_stream) {
...
Network::FilterStatus ReceiverRDMAWriteMultipReadFilter::onWrite(Buffer::Instance& data, bool end_stream) {
