 ...
 */
class ReceiverRDMAWriteMultipReadFilter : 
                       public Network::ReadFilter,
                       public Network::WriteFilter,
                       public Network::ConnectionCallbacks,
                       public std::enable_shared_from_this<ReceiverRDMAWriteMultipReadFilter>,
...
public:
    ...
    // Destructor
    ~ReceiverRDMAWriteMultipReadFilter() {
    ...
    // Constructor
    ReceiverRDMAWriteMultipReadFilter(const uint32_t payloadBound, const uint32_t circleSize, const uint32_t timeToWrite, const uint32_t sharedBufferSize)
    ...
    void setup_rdma() {
		...
		*hostChksum_ = ~(*hostLimit_);
        ...
        rdma_polling_thread_ = std::thread(&ReceiverRDMAWriteMultipReadFilter::rdma_polling, this);        
        rdma_sender_thread_ = std::thread(&ReceiverRDMAWriteMultipReadFilter::rdma_sender, this);
        upstream_sender_thread_ = std::thread(&ReceiverRDMAWriteMultipReadFilter::upstream_sender, this);
    }    
