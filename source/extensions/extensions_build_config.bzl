...
EXTENSIONS = {
    ...
    "envoy.filters.network.receiver_rdma":                        "//source/extensions/filters/network/receiver_rdma:config",
    "envoy.filters.network.receiver_rdma_write_multip_write":     "//source/extensions/filters/network/receiver_rdma_write_multip_write:config",
    "envoy.filters.network.receiver_rdma_write_multip_read":      "//source/extensions/filters/network/receiver_rdma_write_multip_read:config",
    "envoy.filters.network.receiver_rdma_write_nomultip_read":    "//source/extensions/filters/network/receiver_rdma_write_nomultip_read:config",
    "envoy.filters.network.sender_rdma":                          "//source/extensions/filters/network/sender_rdma:config",
    "envoy.filters.network.sender_rdma_write_multip_write":       "//source/extensions/filters/network/sender_rdma_write_multip_write:config",
    "envoy.filters.network.sender_rdma_write_multip_read":        "//source/extensions/filters/network/sender_rdma_write_multip_read:config",
    "envoy.filters.network.sender_rdma_write_nomultip_read":      "//source/extensions/filters/network/sender_rdma_write_nomultip_read:config",
